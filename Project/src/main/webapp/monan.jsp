											...
											<div class="flex-quantity">
												...
												<input type="hidden" name="id" value="${food.id + 1}">
												 <div class="btn-mua button_actions clearfix">
                                                    <div class="btn btn_base normal_button btn_add_cart add_to_cart
                                                    btn-cart">
                                                        <span id="btn">Thêm vào giỏ
                                                            hàng</span>
                                                    </div>
            ...
            <div class="header-popcart">
                ...
                <div class="media-content bodycart-mobile">
                    <div class="thumb-1x1"><img
                            ...
                            alt="Salad rau mùa sốt cam"></div>
                    <div class="body_content">
                        <h4 class="product-title">Salad rau mùa sốt cam</h4>
                        <div class="product-new-price"><span></span><b>68.000₫</b></div>
                    </div>
                </div>
                <a class="noti-cart-count" href="/cart" title="Giỏ hàng">
                    Giỏ hàng của bạn hiện có (<span class="count_item_pr">15</span> món ăn) </a>
